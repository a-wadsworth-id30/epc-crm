...
sent and archive folders for older Lead Inbox emails, and run one bounded
linked-sale backfill batch for missing Pipedrive notes, Lead Inbox
mailbox-thread emails, person emails and file references, then write compact
...
delivery count and latest provider delivery time after a lead, deal or person
is changed in Pipedrive.
