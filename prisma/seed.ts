...
async function main() {
  ...
  const defaultPipelineStages = [
    ...
    },
    {
      ...
      isLost: false,
      color: "#2563EB",
      description: "Qualified opportunity with confirmed commercial potential.",
    },
    {
      ...
      isLost: false,
      color: "#7C3AED",
      description: "Proposal or quote has been issued.",
    },
    {
      ...
      isLost: false,
      color: "#D97706",
      description: "Commercial terms are being discussed.",
    },
    {
