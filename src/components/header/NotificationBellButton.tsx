...
export default function NotificationBellButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      aria-label={`${actionableCount} actionable notifications`}
    >
      {actionableCount > 0 && (
        <span
          className={cn(
            "absolute -top-1 -right-1 z-10 flex h-5 min-w-5 items-center justify-center rounded-full px-1 text-[10px] font-semibold text-white",
