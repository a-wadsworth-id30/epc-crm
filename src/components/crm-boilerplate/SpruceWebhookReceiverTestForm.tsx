...
import {
  testSpruceZapierWebhookReceiverAction,
  type SpruceWebhookReceiverTestState,
} from "@/lib/actions/integrations";

const initialState: SpruceWebhookReceiverTestState = {
  ok: false,
  message: "",
  savedAt: null,
};

export default function SpruceWebhookReceiverTestForm({
  disabled,
}: {
  disabled: boolean;
}) {
