...
export const metadata: Metadata = {
  title: "Maintenance | iD30 CRM",
  description: "The CRM is temporarily down for maintenance.",
};
      ...
      <div>
        <div className="mx-auto w-full max-w-[274px] text-center sm:max-w-[555px]">
          ...
          <p className="mt-6 mb-6 text-base text-gray-700 dark:text-gray-400 sm:text-lg">
            iD30 CRM is currently undergoing maintenance and will be available again shortly.
          </p>
        ...
        <p className="absolute text-sm text-center text-gray-500 -translate-x-1/2 bottom-6 left-1/2 dark:text-gray-400">
          &copy; {new Date().getFullYear()} - iD30 CRM
        </p>
      </div>
    </div>
  );
